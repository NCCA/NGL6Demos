...
void NGLScene::initialize()
{
  ...
  m_cam= new FirstPersonCamera(from,to,up);
...
void NGLScene::render()
{
  ...
  m_cam->rotate(m_spinXFace,m_spinYFace);
...
void NGLScene::keyPressEvent(QKeyEvent *_event)
{
  ...
  case Qt::Key_Up : m_cam->moveForward(-0.00001); break;
  case Qt::Key_Down : m_cam->moveForward(0.00001); break;
