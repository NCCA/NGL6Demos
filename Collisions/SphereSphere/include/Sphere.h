...
public :
	...
	Sphere();
  /// draw method
  void draw(const std::string &_shaderName, ngl::TransformStack &_transformStack, const ngl::Mat4 &_globalTx, ngl::Camera *_cam   )const ;
  void loadMatricesToShader(ngl::TransformStack &_tx,const ngl::Mat4 &_globalTx,  ngl::Camera *_cam  )const;
