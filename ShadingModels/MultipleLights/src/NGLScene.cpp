...
void NGLScene::drawScene(const std::string &_shader)
{
  ...
  m_transformStack.pushTransform();
  {
    m_transformStack.setPosition(ngl::Vec3(-3,0.0,0.0));
    loadMatricesToShader();
  ...
  m_transformStack.pushTransform();
  {
    m_transformStack.setPosition(ngl::Vec3(0.0,0.0,3.0));
    loadMatricesToShader();
    m.change(ngl::BRONZE);
    m.loadToShader("material");
    prim->draw("cube");
  ...
  m_transformStack.pushTransform();
  {
    m_transformStack.setPosition(ngl::Vec3(-3.0,0.0,3.0));
    loadMatricesToShader();
    m.change(ngl::CHROME);
    m.loadToShader("material");
    prim->draw("torus");
  ...
  m_transformStack.pushTransform();
  {
    m_transformStack.setPosition(ngl::Vec3(3.0,0.5,3.0));
    loadMatricesToShader();
    m.change(ngl::COPPER);
    m.loadToShader("material");
  ...
  m_transformStack.pushTransform();
  {
    m_transformStack.setPosition(ngl::Vec3(0.0,0.5,-6.0));
    loadMatricesToShader();
  ...
  m_transformStack.pushTransform();
  {
    m_transformStack.setPosition(ngl::Vec3(-3.0,0.5,-6.0));
  ...
  m_transformStack.pushTransform();
  {
    m_transformStack.setPosition(ngl::Vec3(1.0,0.35,1.0));
  ...
  m_transformStack.pushTransform();
  {
    m_transformStack.setPosition(ngl::Vec3(-1.0,-0.5,1.0));
    m_transformStack.setScale(0.1,0.1,0.1);
    loadMatricesToShader();
    m.change(ngl::COPPER);
    m.loadToShader("material");
    prim->draw("dragon");
  ...
  m_transformStack.pushTransform();
  {
    m_transformStack.setPosition(ngl::Vec3(-2.5,-0.5,1.0));
    m_transformStack.setScale(0.1,0.1,0.1);
    loadMatricesToShader();
    m.change(ngl::CHROME);
    m.loadToShader("material");
  ...
  m_transformStack.pushTransform();
  {
    m_transformStack.setPosition(ngl::Vec3(0.0,-0.5,0.0));
    loadMatricesToShader();
    prim->draw("plane");
  } // and before a pop
  m_transformStack.popTransform();
